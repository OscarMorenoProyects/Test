...
public class Camioneta extends VehiculoElectrico {
    ...
    private boolean tieneAireAcondicionado, tieneCamaraReversa, tieneVelocidadCrucero, tieneABS, tieneSensoresColision, tieneSensorTrafico, tieneAsistentePermaneciaCarril, es4X4;

   
    public Camioneta(String marca, String modelo, String matricula, int cambios, double velocidadMaxima, double cilindraje,
            ...
            boolean tieneAsistentePermaneciaCarril, boolean es4x4) {
